...
class LoginScreen extends StatelessWidget {
  LoginScreen({Key? key}) : super(key: CurdappKeys.mainScreen);
  ...
  Widget build(BuildContext context) {
    return BlocListener<LoginBloc, LoginState>(
      listener: (context, state) {
        ...
        //   Navigator.pushNamed(context, CurdappRoutes.main);
        // }
        Navigator.pushNamed(context, CurdappRoutes.main);
      },
      child: Scaffold(
    ...
    return BlocBuilder<LoginBloc, LoginState>(
        ...
        builder: (context, state) {
          return TextFormField(
              ...
              onChanged: (value) {
                context.read<LoginBloc>().add(LoginChanged(login: value));
              },
  ...
  Widget register(BuildContext context) {
    return ElevatedButton(
      ...
      onPressed: () => Navigator.pushNamed(context, CurdappRoutes.register),
    );
  }
